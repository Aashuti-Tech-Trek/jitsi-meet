...
export default class LargeVideoManager {
    ...
    constructor() {
        ...
        /**
         * The React root for the dominant speaker avatar container.
         * Stored to avoid creating multiple roots on the same DOM node.
         *
         * @type {import('react-dom/client').Root|null}
         */
        this._dominantSpeakerAvatarRoot = null;

        /**
         * The React root for the presence label container.
         * Stored to avoid creating multiple roots on the same DOM node.
         *
         * @type {import('react-dom/client').Root|null}
         */
    ...
    destroy() {
        ...
        if (this._dominantSpeakerAvatarRoot) {
            this._dominantSpeakerAvatarRoot.unmount();
            this._dominantSpeakerAvatarRoot = null;
        }
    ...
    updateAvatar() {
        if (!this._dominantSpeakerAvatarRoot) {
            this._dominantSpeakerAvatarRoot = createRoot(this._dominantSpeakerAvatarContainer);
        }
        this._dominantSpeakerAvatarRoot.render(
